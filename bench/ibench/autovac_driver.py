...
def run_with_params(resume_id, id, initial_size, update_speed, initial_delay, control_autovac, enable_pid):
    ...
    cmd = "python3 iibench.py --setup --dbms=postgres --db_user=postgres --db_password=masterKey3 --max_rows=100000000 --secs_per_report=120 --query_threads=3 --delete_per_insert --max_seconds=120"
...
if __name__ == '__main__':
    ...
    id = c_int64(0)
    for initial_size in [0]:
        for update_speed in [1000]:
